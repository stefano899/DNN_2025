...
def train_loop(dataloader, model, loss_fn, optimizer, epoch, device):
    ...
    checkpoint_dir = r'C:\Users\stefa\Desktop\DNN2025\DNNStefano\DNN\SetA1\models\CNN_HT\Checkpoints'

    # Se la cartella non esiste, la creiamo
    os.makedirs(checkpoint_dir, exist_ok=True)

    # Costruiamo il percorso completo del file checkpoint
    checkpoint_path = os.path.join(checkpoint_dir, f'epoch_{epoch}_Model_CNN_A1_HT.pt')
